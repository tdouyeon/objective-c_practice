...
- (void)viewDidLoad {
    ...
    NSDictionary *dict9 = [[NSDictionary alloc]initWithObjectsAndKeys:@"스위스", @"지역", @"우박", @"날씨", nil];
    
    NSDictionary *dict10 = [[NSDictionary alloc]initWithObjectsAndKeys:@"덴마크", @"지역", @"비", @"날씨", nil];
    
    NSDictionary *dict11 = [[NSDictionary alloc]initWithObjectsAndKeys:@"스웨덴", @"지역", @"눈", @"날씨", nil];
    
    NSDictionary *dict12 = [[NSDictionary alloc]initWithObjectsAndKeys:@"네덜란드", @"지역", @"우박", @"날씨", nil];
    
    NSDictionary *dict13 = [[NSDictionary alloc]initWithObjectsAndKeys:@"크로아티아", @"지역", @"흐림", @"날씨", nil];
    
    NSDictionary *dict14 = [[NSDictionary alloc]initWithObjectsAndKeys:@"필리핀", @"지역", @"맑음", @"날씨", nil];
    ...
    NSDictionary *dict17 = [[NSDictionary alloc]initWithObjectsAndKeys:@"벨기에", @"지역", @"맑음", @"날씨", nil];
    
    NSDictionary *dict18 = [[NSDictionary alloc]initWithObjectsAndKeys:@"핀란드", @"지역", @"눈", @"날씨", nil];
    
    NSDictionary *dict19 = [[NSDictionary alloc]initWithObjectsAndKeys:@"이탈리아", @"지역", @"눈", @"날씨", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *dictTemp = [dataList objectAtIndex:indexPath.row];
    
    NSString *weatherStr = [dictTemp objectForKey:@"날씨"];
    
    cell.textLabel.text = [dictTemp objectForKey:@"지역"];
